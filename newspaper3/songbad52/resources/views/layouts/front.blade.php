...
<div class="home_right container">
<a href="{{ URL::to('/') }}"><img src="{{ asset($setting->favicon ??'') }}" class="pull-right"></a>
</div>
                    @php
...
<div class="modal fade bd-example-modal-lg" action="{{ URL::to('/') }}" tabindex="-1" role="dialog" aria-hidden="true" style="display: none;">
