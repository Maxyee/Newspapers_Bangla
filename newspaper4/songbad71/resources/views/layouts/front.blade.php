...
<p style="text-align: center;">অফিস : {{$setting->address_bn ??''}},  মোবাইল নং: {{ $setting->phone_bn ??''}}, ইমেইল: {{ $setting->email ??''}}</p> </div>
<div class="col-md-12 col-sm-12 editorial_2">
<p style="text-align: center;">অফিস : রুম নং :{{$setting->address_bn ??''}}, মোবাইল নং: {{ $setting->phone_bn ??''}}, ইমেইল: {{ $setting->email ??''}}</p> </div>
